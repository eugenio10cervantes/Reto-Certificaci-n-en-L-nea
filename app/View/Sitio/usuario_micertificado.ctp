...
<?php $this->set("pagina", "usuario_micertificado"); ?>
	...
	<div class="row">
		<div class="col m8 offset-m2 l6 offset-l3 usin-border" style="background-color:white;">
			...
			<div id="usno-contenido">
				...
				<span class="dash-gris-neutro">Mi Certificado</span>
				<br><br>
				...
				<div class="row" style="margin-top:50px;">
					<div class="col l6 offset-l3 m8 offset-m2 center-align">
						<div style="display:table">
							<img src="/img/usuarioycerti-logo-negro.png" width="70">
							<div class="celda" style="color:#9F9F9F; font-weight:bold;">
								Acreditado
							</div>
							<div class="celda">
								<img src="/img/check-color.png" style="margin-top:5px;" width="30">
							</div>
						</div>
				...
				<div class="row" style="margin-top:50px;">
					<div class="col m4 offset-m4">
						<div style="display:table">
							<img src="/img/descarga.png" style="margin-right:20px;" width="30">
							<div class="celda" style="color:#9F9F9F; font-weight:bold;">
